...
-- The original .csv file did not have any null or NaN values, so I made the assumption that
-- I should not allow the insertion of any null values for any field. Without access to a clien
-- this decision cannot be made with 100% confidence.
